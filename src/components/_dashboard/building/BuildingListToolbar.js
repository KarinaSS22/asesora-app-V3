...
function BuildingListToolbar({ numSelected, filterName, onFilterName }) {
  ...
  return (
    ...
    >
      ...
      <Dialog open={open} TransitionComponent={Transition} onClose={handleClose}>
        ...
        <DialogContent>
          estas a punto de eliminar {numSelected} edificio{numSelected > 1 ? 's ' : ' '}
...
export default BuildingListToolbar;